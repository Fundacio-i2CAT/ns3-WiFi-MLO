...
//custom code 1
void fun() const;
NetDeviceContainer Install (const WifiPhyHelper &phyHelper1,const WifiPhyHelper &phyHelper2,
...
NetDeviceContainer Install (const WifiPhyHelper &phy1,const WifiPhyHelper &phy2,
