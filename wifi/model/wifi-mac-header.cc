...
//add custom function
void WifiMacHeader::SetlinkId (u_int64_t l)
{
  linkId=l;
}

void WifiMacHeader::Setdelay (u_int64_t d){
  delay=d;
}
  

u_int64_t WifiMacHeader::getdelay() const{
  return delay;
}
u_int64_t WifiMacHeader::getlinkId () const
{
  return linkId;
}
