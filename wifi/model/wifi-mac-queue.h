...
public:
 ...
 void Inclink2();
   ...
   * \return the packet
   */
  Ptr<const WifiMacQueueItem> Peek (u_int8_t linkID) const ;
  ...
  void Count_packet_inQUEUE();
  Ptr<const WifiMacQueueItem> SearchIITEM(int linkId,const Ptr<QosBlockedDestinations> blockedPackets=nullptr,Ptr<const WifiMacQueueItem> item=nullptr) const;
