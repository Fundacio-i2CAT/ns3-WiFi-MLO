                                          ...
                                          uint16_t timeout, bool immediateBAck)
{
  ...
  txParams.m_txVector =
      m_mac->GetWifiRemoteStationManager ()->GetDataTxVector (mpdu->GetHeader (), m_allowedWidth);
                                                 ...
                                                 Mac48Address originator, uint16_t startingSeq)
{
  ...
  RecipientBlockAckAgreement agreement (
      originator, respHdr->IsAmsduSupported (), tid, respHdr->GetBufferSize (),
      respHdr->GetTimeout (), startingSeq,
  ...
  if (respHdr->GetTimeout () != 0)
    {
      ...
      agreement.m_inactivityEvent = Simulator::Schedule (
          timeout, &HtFrameExchangeManager::SendDelbaFrame, this, originator, tid, false);
    }
...
int HtFrameExchangeManager::varr = 0;
bool
HtFrameExchangeManager::StartFrameExchange (Ptr<QosTxop> edca, Time availableTime,
                                            bool initialFrame)
{
  ...
  Ptr<const WifiMacQueueItem> peekedItem = edca->PPeekNextMpdu (m_linkId);
...
bool
HtFrameExchangeManager::SendMpduFromBaManager (Ptr<QosTxop> edca, Time availableTime,
                                               bool initialFrame)
{
  NS_LOG_FUNCTION (this << edca << availableTime << initialFrame);
  ...
  WifiBlockAck *blockAcknowledgment =
      static_cast<WifiBlockAck *> (txParams.m_acknowledgment.get ());
  ...
  Time barTxDuration = m_phy->CalculateTxDuration (
      peekedItem->GetSize (), blockAcknowledgment->blockAckTxVector, m_phy->GetPhyBand ());
...
bool
HtFrameExchangeManager::SendDataFrame (Ptr<const WifiMacQueueItem> peekedItem, Time availableTime,
                                       bool initialFrame)
{
  ...
  //         int n=-2;
  //  n=this->getLinkId();
  // if(peekedItem->GetPacketSize()==736)
  // {

  //   if(n==1)
  //   return false;
  // }
  // else if(peekedItem->GetPacketSize()==386)
  // {
  //   if(n==0)
  //   return false;
  ...
  Ptr<WifiMacQueueItem> mpdu =
      edca->GetNextMpdu (peekedItem, txParams, availableTime, initialFrame);
  ...
  if (acknowledgment->method == WifiAcknowledgment::BLOCK_ACK)
    {
      ...
      Time baTxDuration =
          m_phy->CalculateTxDuration (GetBlockAckSize (blockAcknowledgment->baType),
...
HtFrameExchangeManager::ForwardMpduDown (Ptr<WifiMacQueueItem> mpdu, WifiTxVector &txVector)
{
  ...
  //  int t=now.GetMicroSeconds();
  // mpdu->GetHeader().Setdelay(t);
...
bool HtFrameExchangeManager::calculate_statics = true;



u_int64_t HtFrameExchangeManager::ThroughputSTA11 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA11_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA11_link2 = 0;


u_int64_t HtFrameExchangeManager::ThroughputSTA10 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA10_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA10_link2 = 0;

u_int64_t HtFrameExchangeManager::ThroughputSTA9 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA9_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA9_link2 = 0;

u_int64_t HtFrameExchangeManager::ThroughputSTA8 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA8_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA8_link2 = 0;

u_int64_t HtFrameExchangeManager::ThroughputSTA7 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA7_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA7_link2 = 0;

u_int64_t HtFrameExchangeManager::ThroughputSTA6 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA6_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA6_link2 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA5 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA5_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA5_link2 = 0;

u_int64_t HtFrameExchangeManager::ThroughputSTA4 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA4_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA4_link2 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA3 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA3_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA3_link2 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA1_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA1_link2 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA2 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA2_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputSTA2_link2 = 0;
u_int64_t HtFrameExchangeManager::ThroughputAP = 0;
u_int64_t HtFrameExchangeManager::ThroughputAP_link1 = 0;
u_int64_t HtFrameExchangeManager::ThroughputAP_link2 = 0;
u_int64_t HtFrameExchangeManager::AvgDelay = 0;
u_int64_t HtFrameExchangeManager::countD = 0;
void
HtFrameExchangeManager::NotifyReceivedNormalAck (Ptr<WifiMacQueueItem> mpdu)
{
  ...
  if (calculate_statics && mpdu->GetHeader ().IsData ())
    {
      
      u_int64_t now = Simulator::Now ().GetMicroSeconds ();
      now = now - mpdu->GetHeader ().getdelay ();
    
   
       

//STA11 Delay and throughput
      std::ofstream WriteSTA11, WriteSTA11_link1, WriteSTA11_link2;
      WriteSTA11.open ("FreshScenarios/LogDelayThroughputSTA11.txt", std::ios::app);
      WriteSTA11_link1.open ("FreshScenarios/LogDelaySTA11Link1.txt", std::ios::app);
      WriteSTA11_link2.open ("FreshScenarios/LogDelaySTA11Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 11||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 11)
        {
          WriteSTA11 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA11<< "," << now
          <<","<<mpdu->GetPacketSize () << std::endl;
                    
          int nn = -2;
          nn = m_linkId;
          
          if (m_linkId == 0)
            WriteSTA11_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA11_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA11_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA11_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA7 ends

      WriteSTA11_link1.close ();
      WriteSTA11_link2.close ();
      WriteSTA11.close ();



//STA10 Delay and throughput
      std::ofstream WriteSTA10, WriteSTA10_link1, WriteSTA10_link2;
      WriteSTA10.open ("FreshScenarios/LogDelayThroughputSTA10.txt", std::ios::app);
      WriteSTA10_link1.open ("FreshScenarios/LogDelaySTA10Link1.txt", std::ios::app);
      WriteSTA10_link2.open ("FreshScenarios/LogDelaySTA10Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 10||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 10)
        {
          WriteSTA10 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA10<< "," << now
          <<","<<mpdu->GetPacketSize () << std::endl;
          ...
          if (m_linkId == 0)
            WriteSTA10_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA10_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA10_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA10_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA7 ends

      WriteSTA10_link1.close ();
      WriteSTA10_link2.close ();
WriteSTA10.close ();
//STA9 Delay and throughput
      std::ofstream WriteSTA9, WriteSTA9_link1, WriteSTA9_link2;
      WriteSTA9.open ("FreshScenarios/LogDelayThroughputSTA9.txt", std::ios::app);
      WriteSTA9_link1.open ("FreshScenarios/LogDelaySTA9Link1.txt", std::ios::app);
      WriteSTA9_link2.open ("FreshScenarios/LogDelaySTA9Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 9||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 9)
        {
          WriteSTA9 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA9<< "," << now
          <<","<<mpdu->GetPacketSize () << std::endl;
          ...
          if (m_linkId == 0)
            WriteSTA9_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA9_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA9_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA9_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA7 ends

      WriteSTA9_link1.close ();
      WriteSTA9_link2.close ();
      WriteSTA9.close ();
       

        //STA8 Delay and throughput
      std::ofstream WriteSTA8, WriteSTA8_link1, WriteSTA8_link2;
      WriteSTA8.open ("FreshScenarios/LogDelayThroughputSTA8.txt", std::ios::app);
      WriteSTA8_link1.open ("FreshScenarios/LogDelaySTA8Link1.txt", std::ios::app);
      WriteSTA8_link2.open ("FreshScenarios/LogDelaySTA8Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 8||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 8)
        {
          WriteSTA8 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA8 << "," << now
          <<","<<mpdu->GetPacketSize () << std::endl;
          ...
          if (m_linkId == 0)
            WriteSTA8_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA8_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA8_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA8_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA7 ends

      WriteSTA8_link1.close ();
      WriteSTA8_link2.close ();
      WriteSTA8.close ();
        ...
        //STA7 Delay and throughput
      std::ofstream WriteSTA7, WriteSTA7_link1, WriteSTA7_link2;
      WriteSTA7.open ("FreshScenarios/LogDelayThroughputSTA7.txt", std::ios::app);
      WriteSTA7_link1.open ("FreshScenarios/LogDelaySTA7Link1.txt", std::ios::app);
      WriteSTA7_link2.open ("FreshScenarios/LogDelaySTA7Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 7||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 7)
        {
          WriteSTA7 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA7 << "," << now
          <<","<<mpdu->GetPacketSize () << std::endl;
          ...
          if (m_linkId == 0)
            WriteSTA7_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA7_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA7_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA7_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA7 ends

      WriteSTA7_link1.close ();
      WriteSTA7_link2.close ();
      WriteSTA7.close ();
       ...
       //STA6 Delay and throughput
      std::ofstream WriteSTA6, WriteSTA6_link1, WriteSTA6_link2;
      WriteSTA6.open ("FreshScenarios/LogDelayThroughputSTA6.txt", std::ios::app);
      WriteSTA6_link1.open ("FreshScenarios/LogDelaySTA6Link1.txt", std::ios::app);
      WriteSTA6_link2.open ("FreshScenarios/LogDelaySTA6Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 6||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 6)
        {
          WriteSTA6 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA6 << "," << now
          <<","<<mpdu->GetPacketSize () << std::endl;
          ...
          if (m_linkId == 0)
            WriteSTA6_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA6_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA6_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA6_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA4 ends

      WriteSTA6_link1.close ();
      WriteSTA6_link2.close ();
      WriteSTA6.close ();
 //STA5 Delay and throughput
      std::ofstream WriteSTA5, WriteSTA5_link1, WriteSTA5_link2;
      WriteSTA5.open ("FreshScenarios/LogDelayThroughputSTA5.txt", std::ios::app);
      WriteSTA5_link1.open ("FreshScenarios/LogDelaySTA5Link1.txt", std::ios::app);
      WriteSTA5_link2.open ("FreshScenarios/LogDelaySTA5Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 5||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 5)
        {
          WriteSTA5 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA5 << "," << now
          <<","<<mpdu->GetPacketSize () << std::endl;
          ...
          if (m_linkId == 0)
            WriteSTA5_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA5_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA5_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA5_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA4 ends

      WriteSTA5_link1.close ();
      WriteSTA5_link2.close ();
      WriteSTA5.close ();
  //STA4 Delay and throughput
      std::ofstream WriteSTA4, WriteSTA4_link1, WriteSTA4_link2;
      WriteSTA4.open ("FreshScenarios/LogDelayThroughputSTA4.txt", std::ios::app);
      WriteSTA4_link1.open ("FreshScenarios/LogDelaySTA4Link1.txt", std::ios::app);
      WriteSTA4_link2.open ("FreshScenarios/LogDelaySTA4Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 4||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 4)
        {
          WriteSTA4 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA4 << "," << now
          <<","<<mpdu->GetPacketSize () << std::endl;
          int nn = -2;
          nn = m_linkId;
          
          if (m_linkId == 0)
            WriteSTA4_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA4_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA4_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA4_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA4 ends

      WriteSTA4_link1.close ();
      WriteSTA4_link2.close ();
      WriteSTA4.close ();



      //STA3 Delay and throughput
      std::ofstream WriteSTA3, WriteSTA3_link1, WriteSTA3_link2;
      WriteSTA3.open ("FreshScenarios/LogDelayThroughputSTA3.txt", std::ios::app);
      WriteSTA3_link1.open ("FreshScenarios/LogDelaySTA3Link1.txt", std::ios::app);
      WriteSTA3_link2.open ("FreshScenarios/LogDelaySTA3Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 3||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 3)
        {
          WriteSTA3 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA3 << "," << now
                     <<","<<mpdu->GetPacketSize ()<< std::endl;
          int nn = -2;
          nn = m_linkId;
          
          if (m_linkId == 0)
            WriteSTA3_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA3_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA3_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA3_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA2 ends

      WriteSTA3_link1.close ();
      WriteSTA3_link2.close ();
      WriteSTA3.close ();



      //STA2 Delay and throughput(link wise delay only)
      std::ofstream WriteSTA2, WriteSTA2_link1, WriteSTA2_link2;
      WriteSTA2.open ("FreshScenarios/LogDelayThroughputSTA2.txt", std::ios::app);
      WriteSTA2_link1.open ("FreshScenarios/LogDelaySTA2Link1.txt", std::ios::app);
      WriteSTA2_link2.open ("FreshScenarios/LogDelaySTA2Link2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 2||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 2)
        {
          WriteSTA2 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA2 << "," << now
                     <<","<<mpdu->GetPacketSize ()<< std::endl;
          int nn = -2;
          nn = m_linkId;
          
          if (m_linkId == 0)
            WriteSTA2_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA2_link1 << "," << mpdu->GetPacketSize ()
                            << std::endl;
          if (m_linkId == 1)
            WriteSTA2_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                            << "," << ++ThroughputSTA2_link2 << "," << mpdu->GetPacketSize ()
                            << std::endl;
        } //if of STA2 ends

      WriteSTA2_link1.close ();
      WriteSTA2_link2.close ();
      WriteSTA2.close ();
...
//             //new code of flow  
//       //STA2 Delay per flows wideand throughput(link wise delay only)
//       // std::ofstream WriteSTA2_, WriteSTA2_link1, WriteSTA2_link2;
      
//       if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 2||mpdu->GetHeader ().GetAddr1 ().ConvertIntoInt () == 2)
//         {

//           if(mpdu->GetPacketSize ()>60)
//           {
//             WriteSTA2.open ("FreshScenarios/LogDelayThroughputSTA2_flow1.txt", std::ios::app);
//             WriteSTA2_link1.open ("FreshScenarios/LogDelaySTA2Link1_flow1.txt", std::ios::app);
//             WriteSTA2_link2.open ("FreshScenarios/LogDelaySTA2Link2_flow1.txt", std::ios::app);
//           }
//           else
//           {
//             WriteSTA2.open ("FreshScenarios/LogDelayThroughputSTA2_flow2.txt", std::ios::app);
//             WriteSTA2_link1.open ("FreshScenarios/LogDelaySTA2Link1_flow2.txt", std::ios::app);
//             WriteSTA2_link2.open ("FreshScenarios/LogDelaySTA2Link2_flow2.txt", std::ios::app);
      

//           }
          

//           WriteSTA2 << Simulator::Now ().GetMicroSeconds () << "," << 0 << "," << now
//                      <<","<<mpdu->GetPacketSize ()<< std::endl;
//           int nn = -2;
//           nn = m_linkId;
...
// //end new code of flows
      ...
      //STA 1 statics
      std::ofstream WriteSTA1, WriteSTA1_link1, WriteSTA1_link2, STA1_Delay, STA1_L1_Delay,
          STA1_L2_Delay;
      WriteSTA1.open ("FreshScenarios/LogDelayThroughputSTA1.txt", std::ios::app);
      WriteSTA1_link1.open ("FreshScenarios/LogDelaySTA1Link1.txt", std::ios::app);
      WriteSTA1_link2.open ("FreshScenarios/LogDelaySTA1Link2.txt", std::ios::app);
    
      
      // STA1_Delay.open ("FreshScenarios/STA1_Delay.txt");
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 1||mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 1)
        {
          
          
          WriteSTA1 << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputSTA1 << "," << now
                     <<","<<mpdu->GetPacketSize ()<< std::endl;
          // STA1_Delay << now << std::endl;
            ST1_D=now;
          int nn = -2;
          nn = m_linkId;
          if (m_linkId == 0)
            {
              ST1_l1=now;
              WriteSTA1_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                              << "," << ++ThroughputSTA1_link1 << "," << mpdu->GetPacketSize ()
                              << std::endl;
              STA1_L1_Delay.open ("FreshScenarios/STA1_L1_Delay.txt");
              STA1_L1_Delay << now << std::endl;
              STA1_L1_Delay.close ();
            }
          if (m_linkId == 1)
            {
              ST1_l2=now;
              WriteSTA1_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now
                              << "," << ++ThroughputSTA1_link2 << "," << mpdu->GetPacketSize ()
                              << std::endl;
              STA1_L2_Delay.open ("FreshScenarios/STA1_L2_Delay.txt");
              STA1_L2_Delay << now << std::endl;
              STA1_L2_Delay.close ();
            }
        } //if of STA1 ends
      // STA1_Delay.close ();
      ...
      WriteSTA1_link1.close ();
      WriteSTA1_link2.close ();
      WriteSTA1.close ();

      //AP statics
      std::ofstream WriteAP, WriteAP_link1, WriteAP_link2;
      WriteAP.open ("FreshScenarios/LogDelayThroughputAP.txt", std::ios::app);
      WriteAP_link1.open ("FreshScenarios/LogDelayAPLink1.txt", std::ios::app);
      WriteAP_link2.open ("FreshScenarios/LogDelayAPLink2.txt", std::ios::app);
      if (mpdu->GetHeader ().GetAddr2 ().ConvertIntoInt () == 100)
        {

          WriteAP << Simulator::Now ().GetMicroSeconds () << "," << ++ThroughputAP << "," << now
                  << std::endl;
          int nn = -2;
          nn = m_linkId;
          if (m_linkId == 0)
            WriteAP_link1 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now << ","
                          << ++ThroughputAP_link1 << "," << mpdu->GetPacketSize () << std::endl;
          if (m_linkId == 1)
            WriteAP_link2 << Simulator::Now ().GetMicroSeconds () << "," << nn << "," << now << ","
                          << ++ThroughputAP_link2 << "," << mpdu->GetPacketSize () << std::endl;
        } //if AP statics ends
      ...
      //Over all Delay statics of network
      std::ofstream write, twofile, ThreeFile;
      write.open ("FreshScenarios/LogDelay.txt", std::ios::app);
      // twofile.open ("FreshScenarios/Lin1Delay.txt", std::ios::app);
      // ThreeFile.open ("FreshScenarios/Lin2Delay.txt", std::ios::app);
      ...
      if (mpdu->GetHeader ().IsData ())
        {
          if (countD++ <= 30)
            ...
            {
              AvgDelay = .8 * AvgDelay + .2 * now;
              write << Simulator::Now ().GetMicroSeconds () << "\t\t" << now << "\t\t"
                    << mpdu->GetPacketSize () << "\t\t\t" << AvgDelay << std::endl;
              if (link == 0)
                twofile << Simulator::Now ().GetMicroSeconds () << "," << now << std::endl;
              else
                ThreeFile << Simulator::Now ().GetMicroSeconds () << "," << now << std::endl;
      ...
      if (actionHdr.GetCategory () == WifiActionHeader::BLOCK_ACK)
        {
          if (actionHdr.GetAction ().blockAck == WifiActionHeader::BLOCK_ACK_DELBA)
          ...
          else if (actionHdr.GetAction ().blockAck == WifiActionHeader::BLOCK_ACK_ADDBA_REQUEST)
            {
              ...
              //here
              // int n=mpdu->GetPacketSize();
             

              MgtAddBaRequestHeader addBa;
              p->PeekHeader (addBa);
              Ptr<QosTxop> edca = m_mac->GetQosTxop (addBa.GetTid ());
              Simulator::Schedule (edca->GetAddBaResponseTimeout (), &QosTxop::AddBaResponseTimeout,
                                   edca, mpdu->GetHeader ().GetAddr1 (), addBa.GetTid ());
            }
        }
    }
...
HtFrameExchangeManager::TransmissionSucceeded (void)
{
  ...
  if (m_edca && m_edca->GetTxopLimit (m_linkId).IsZero () &&
      m_edca->GetBaManager ()->GetBar (false))
    {
...
int HtFrameExchangeManager::RetransmissionCount = 0;
void
  ...
  if (calculate_statics)
    {
      ...
      // write.open ("FreshScenarios/LogRetransmission.txt", std::ios::app);
      int diff = Simulator::Now ().GetMicroSeconds ();
      int link=m_linkId;
      diff = diff - mpdu->GetHeader ().getdelay ();
      //write<<"T Now "<<"\t\tT sent"<<"\t\tDifference"<<"\tcount is\t"<<"Seq#\n";

      // write << Simulator::Now ().GetMicroSeconds () << "," << ++RetransmissionCount <<","<<mpdu->GetHeader().GetAddr2().ConvertIntoInt() 

      // <<","<< mpdu->GetHeader ().GetSequenceNumber () << ","<<link<<std::endl;
...
HtFrameExchangeManager::ForwardPsduDown (Ptr<const WifiPsdu> psdu, WifiTxVector &txVector)
{
  ...
  //  if(psdu->GetSize()==770&& m_phy->GetChannelNumber()==50)
  // m_phy->Send (psdu, txVector);
  // else if(psdu->GetSize()==420&& m_phy->GetChannelNumber()==114)
  // m_phy->Send (psdu, txVector);
  // else if(psdu->GetSize()<400)
...
bool
HtFrameExchangeManager::IsWithinAmpduSizeLimit (uint32_t ampduSize, Mac48Address receiver,
                                                uint8_t tid, WifiModulationClass modulation) const
{
...
bool
HtFrameExchangeManager::TryAggregateMsdu (Ptr<const WifiMacQueueItem> msdu,
                                          WifiTxParameters &txParams, Time availableTime) const
{
  ...
  if (hdr.IsCtl ())
    {
      if (hdr.IsCts () && m_txTimer.IsRunning () &&
          m_txTimer.GetReason () == WifiTxTimer::WAIT_CTS && m_psdu)
        {
          ...
          m_mac->GetWifiRemoteStationManager ()->ReportRtsOk (m_psdu->GetHeader (0), rxSnr,
               ...
               m_txTimer.GetReason () == WifiTxTimer::WAIT_BLOCK_ACK && hdr.GetAddr1 () == m_self)
        {
          ...
          m_mac->GetWifiRemoteStationManager ()->ReportAmpduTxStatus (
              hdr.GetAddr2 (), ret.first, ret.second, rxSnr, tag.Get (), m_txParams.m_txVector);
      ...
      else if (hdr.IsBlockAckReq ())
        {
          ...
          Simulator::Schedule (
              m_phy->GetSifs (), &HtFrameExchangeManager::SendBlockAck, this, agreementIt->second,
              hdr.GetDuration (),
              m_mac->GetWifiRemoteStationManager ()->GetBlockAckTxVector (sender, txVector), rxSnr);
        }
      else
        {
          ...
          if (!inAmpdu && hdr.GetQosAckPolicy () == WifiMacHeader::NORMAL_ACK)
            {
              ...
              Simulator::Schedule (m_phy->GetSifs (), &HtFrameExchangeManager::SendNormalAck, this,
                                   hdr, txVector, rxSnr);
            }
          return;
        }
      ...
      if (ackPolicy == WifiMacHeader::NORMAL_ACK)
        {
          ...
          Simulator::Schedule (m_phy->GetSifs (), &HtFrameExchangeManager::SendBlockAck, this,
                               ...
                               m_mac->GetWifiRemoteStationManager ()->GetBlockAckTxVector (
